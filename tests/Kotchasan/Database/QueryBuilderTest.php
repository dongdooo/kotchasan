...
/**
 * Generated by PHPUnit_SkeletonGenerator on 2016-03-30 at 22:16:07.
 */
class QueryBuilderTest extends \PHPUnit_Framework_TestCase
{
	...
	/**
	 * Generated from @assert delete('user', array(array('id', 1), array('name', 'test')))->text() [==] "DELETE FROM `user` WHERE `id` = 1 AND `name`=:name".
	 *
	...
	public function testDelete()
	{
		...
		$this->assertEquals(
			"DELETE FROM `user` WHERE `id` = 1 AND `name`=:name", $this->object->delete('user', array(array('id', 1), array('name', 'test')))->text()
		);
	}
